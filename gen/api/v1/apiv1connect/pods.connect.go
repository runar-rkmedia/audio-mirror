...
type FeedServiceClient interface {
	GetChannels(context.Context, *connect.Request[v1.ChannelsRequest]) (*connect.Response[v1.ChannelsResponse], error)
}
...
func NewFeedServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FeedServiceClient {
	...
	return &feedServiceClient{
		getChannels: connect.NewClient[v1.ChannelsRequest, v1.ChannelsResponse](
			httpClient,
...
type feedServiceClient struct {
	getChannels *connect.Client[v1.ChannelsRequest, v1.ChannelsResponse]
}

// GetChannels calls api.v1.FeedService.GetChannels.
func (c *feedServiceClient) GetChannels(ctx context.Context, req *connect.Request[v1.ChannelsRequest]) (*connect.Response[v1.ChannelsResponse], error) {
...
func (UnimplementedFeedServiceHandler) GetChannels(context.Context, *connect.Request[v1.ChannelsRequest]) (*connect.Response[v1.ChannelsResponse], error) {
